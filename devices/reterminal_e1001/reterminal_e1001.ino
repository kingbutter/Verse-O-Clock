...
// E1001 is 7.5" monochrome 800x480. Many units use UC8179-class controllers.
// This driver is the same one used by your XIAO 7.5" build. Adjust if your panel differs.
